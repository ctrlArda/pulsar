...
export const uiText = {
  tr: {
    localeLabel: "TR",
    title: "Milli Uzay Havasi Platformu",
    sources: "Operasyon omurgasi: NOAA SWPC, NASA DONKI, CelesTrak, Overpass / Turkiye geneli",
    ...
    reportSubtitle: "Gercek veri + fizik + ML + kurumsal entegrasyon katmani",
  ...
  en: {
    localeLabel: "EN",
    title: "National Space Weather Platform",
    sources: "Operational backbone: NOAA SWPC, NASA DONKI, CelesTrak, Overpass / Nationwide Turkey",
    ...
    reportSubtitle: "Real data + physics + ML + institutional integration layer",
